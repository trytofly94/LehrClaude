...
Gespeichert unter:
`1_Exportierte_Ergebnisse/Klassenverwaltung/Schuelerprofile/[Pseudonym].md`
...
### Lese-Zugriff
- Template aus `2_Zentrale_Ressourcen/Templates/schuelerprofil-vorlage.md` (falls vorhanden)

### Schreib-Zugriff
- Speicherort: `1_Exportierte_Ergebnisse/Klassenverwaltung/Schuelerprofile/[Pseudonym].md`
...
- **Templates:** `2_Zentrale_Ressourcen/Templates/schuelerprofil-vorlage.md` (optional)
